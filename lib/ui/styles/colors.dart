...
class MoggieColors {
  ...
  static Color specificContentExtraLow = const Color(0xffFFFFFF).withOpacity(.80);
  ...
  static Color specificBackgroundOverlay1 = const Color(0xff000000).withOpacity(.25);
  static Color specificBackgroundOverlay2 = const Color(0xffFFFFFF).withOpacity(.5);
  // Surface
  ...
  static Color specificSurfaceExtraLow = const Color(0xffFFFFFF).withOpacity(.12);
  // Border
